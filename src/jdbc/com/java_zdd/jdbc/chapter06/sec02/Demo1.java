...
public class Demo1 {
    ...
    private static int addBook(Book book)throws Exception{
        ...
        pstmt.setBinaryStream(8,inputStream2,pic.length());
    ...
    public static void main(String[] args) throws Exception{
        ...
        File pic = new File("d:"+File.separator+"data"+File.separator+"picture.jpg");
        Book book = new Book("房奴向钱冲2","克拉使者2","女",22.0f,"买房一切都为了结婚和以后孩子的良好教育，父母为了自己孩子什么都能苦，都能累。",9,context,pic);
